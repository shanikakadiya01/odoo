...
export const getCities = async ({ search = '', region = 'All', costIndex = 'All', sortBy = 'popularity' } = {}) => {
  ...
  // Built-in fallback catalog (always fresh - avoids stale cache from previous sessions)
...
export const apiLogin = async (email, password) => {
  ...
  const demoUser = {
    ...
    savedDestinations: ['city_paris_01', 'city_tokyo_02']
  };
...
function getDefaultCities() {
  return [
    ...
    },
    {
      ...
      popularityScore: 92,
      matchPercent: 91,
      imageUrl: 'https://images.unsplash.com/photo-1597040663342-45b6af3d91a5?auto=format&fit=crop&w=1200&q=80',
      description: 'A vibrant capital blending centuries of Mughal history with a bustling modern metropolis, renowned for its street food, grand monuments and the electrifying chaos of Chandni Chowk.',
    ...
    },
    {
      ...
      description: "India's financial powerhouse and Bollywood heartland - a city of dramatic contrasts where colonial architecture meets ultra-modern skylines, dabba wallahs, and legendary street food.",
      climate: 'Tropical (Best: Nov - Feb)',
      currency: 'INR',
      highlights: ['Gateway of India', 'Marine Drive', 'Dharavi', 'Chhatrapati Shivaji Terminus'],
      topActivities: [
        { id: 'act_mum1', title: 'Gateway of India & Elephanta Caves Ferry', category: 'Sightseeing', estimatedCost: 18, durationHours: 4 },
        { id: 'act_mum2', title: 'Marine Drive Sunset & Chowpatty Beach Walk', category: 'Culture', estimatedCost: 5, durationHours: 2 },
        { id: 'act_mum3', title: 'Dharavi Slum Reality Tour', category: 'Culture', estimatedCost: 22, durationHours: 2.5 },
        { id: 'act_mum4', title: 'Mohammed Ali Road Iftar Street Food Trail', category: 'Food & Dining', estimatedCost: 15, durationHours: 2 }
      ]
    },
    {
      _id: 'city_jaipur_17',
      ...
      popularityScore: 91,
      matchPercent: 89,
      imageUrl: 'https://images.unsplash.com/photo-1477587458883-47145ed6979e?auto=format&fit=crop&w=1200&q=80',
      description: 'The Pink City of Rajasthan enchants visitors with majestic forts, ornate palaces, vibrant bazaars selling gemstones and block-print textiles, and the iconic Hawa Mahal facade.',
      climate: 'Semi-arid (Best: Oct - Mar)',
      currency: 'INR',
      highlights: ['Amer Fort', 'Hawa Mahal', 'City Palace', 'Jantar Mantar'],
      topActivities: [
        { id: 'act_jai1', title: 'Amer Fort Elephant Ride & Sound-Light Show', category: 'Culture', estimatedCost: 20, durationHours: 3.5 },
        { id: 'act_jai2', title: 'Hawa Mahal & Old City Pink Bazaar Walk', category: 'Sightseeing', estimatedCost: 8, durationHours: 2.5 },
        { id: 'act_jai3', title: 'Nahargarh Fort Sunset & Rooftop Dinner', category: 'Culture', estimatedCost: 25, durationHours: 3 },
        { id: 'act_jai4', title: 'Johari Bazaar Gemstone & Jewellery Tour', category: 'Culture', estimatedCost: 5, durationHours: 2 }
      ]
    },
    {
      _id: 'city_goa_18',
      ...
      description: "India's sun-kissed coastal gem - a relaxed paradise of golden beaches, Portuguese baroque churches, cashew feni bars, spicy fish curries, and legendary sunset beach parties.",
      climate: 'Tropical (Best: Nov - Feb)',
      currency: 'INR',
      highlights: ['Calangute Beach', 'Basilica of Bom Jesus', 'Dudhsagar Falls', 'Old Goa Churches'],
      topActivities: [
        { id: 'act_goa1', title: 'Dudhsagar Falls Jeep Safari & Waterfall Swim', category: 'Adventure', estimatedCost: 28, durationHours: 6 },
        { id: 'act_goa2', title: 'Old Goa Portuguese Church Heritage Walk', category: 'Culture', estimatedCost: 8, durationHours: 2.5 },
        { id: 'act_goa3', title: 'Anjuna Flea Market & Beachside Seafood Lunch', category: 'Food & Dining', estimatedCost: 18, durationHours: 3 },
        { id: 'act_goa4', title: 'Sunset Cruise on the Mandovi River', category: 'Sightseeing', estimatedCost: 15, durationHours: 2 }
      ]
    },
    {
      _id: 'city_agra_19',
      ...
      description: "Home to the world's most celebrated monument of love - the Taj Mahal - along with the imposing Agra Fort and the serene Itimad-ud-Daula tomb along the Yamuna river.",
      climate: 'Semi-arid (Best: Oct - Mar)',
      currency: 'INR',
      highlights: ['Taj Mahal', 'Agra Fort', 'Itimad-ud-Daula', 'Mehtab Bagh'],
      topActivities: [
        { id: 'act_agr1', title: 'Taj Mahal Sunrise Visit with Skip-the-Line Entry', category: 'Sightseeing', estimatedCost: 20, durationHours: 3 },
        { id: 'act_agr2', title: 'Agra Fort Mughal History Guided Tour', category: 'Culture', estimatedCost: 14, durationHours: 2.5 },
        { id: 'act_agr3', title: 'Mehtab Bagh Moonlight Taj Mahal View', category: 'Sightseeing', estimatedCost: 8, durationHours: 1.5 },
        { id: 'act_agr4', title: 'Petha Sweet & Agra Street Food Tasting', category: 'Food & Dining', estimatedCost: 10, durationHours: 2 }
      ]
    },
    {
      _id: 'city_udaipur_20',
      ...
      region: 'Asia',
      costIndex: '$',
      averageDailyBudget: 42,
      popularityScore: 91,
      matchPercent: 92,
      imageUrl: 'https://images.unsplash.com/photo-1602215253994-3dc6e0f2bdf3?auto=format&fit=crop&w=1200&q=80',
      description: 'The City of Lakes — a romantic Rajasthani jewel of shimmering lake palaces, intricate havelis, and the breathtaking Lake Pichola ringed by the Aravalli hills.',
      climate: 'Semi-arid (Best: Sep - Mar)',
      currency: 'INR',
      highlights: ['Lake Pichola', 'City Palace', 'Jag Mandir', 'Sajjangarh Monsoon Palace'],
      topActivities: [
        { id: 'act_uda1', title: 'Lake Pichola Sunset Boat Ride to Jag Mandir', category: 'Sightseeing', estimatedCost: 18, durationHours: 2 },
        { id: 'act_uda2', title: 'City Palace Museum & Zenana Mahal Tour', category: 'Culture', estimatedCost: 15, durationHours: 3 },
        { id: 'act_uda3', title: 'Sajjangarh Monsoon Palace Sunset Trek', category: 'Adventure', estimatedCost: 10, durationHours: 2.5 },
        { id: 'act_uda4', title: 'Havelis & Gangaur Ghat Old City Walk', category: 'Culture', estimatedCost: 5, durationHours: 2 }
      ]
    },
    {
      _id: 'city_varanasi_21',
      name: 'Varanasi',
      country: 'India',
      region: 'Asia',
      costIndex: '$',
      ...
      popularityScore: 89,
      matchPercent: 87,
      imageUrl: 'https://images.unsplash.com/photo-1561361058-c24e021e8f77?auto=format&fit=crop&w=1200&q=80',
      description: "One of the world's oldest continuously inhabited cities and Hinduism's holiest pilgrimage site - where life and death converge on the ancient ghats of the sacred Ganges river.",
      climate: 'Humid Subtropical (Best: Oct - Mar)',
      currency: 'INR',
      highlights: ['Dashashwamedh Ghat', 'Kashi Vishwanath Temple', 'Sarnath', 'Manikarnika Ghat'],
      topActivities: [
        { id: 'act_var1', title: 'Ganga Aarti Ceremony at Dashashwamedh Ghat', category: 'Culture', estimatedCost: 5, durationHours: 1.5 },
        { id: 'act_var2', title: 'Sunrise Boat Ride on the Holy Ganges', category: 'Sightseeing', estimatedCost: 12, durationHours: 2 },
        { id: 'act_var3', title: 'Sarnath Buddhist Ruins & Museum Day Trip', category: 'Culture', estimatedCost: 15, durationHours: 3.5 },
        { id: 'act_var4', title: 'Kashi Vishwanath Lane & Street Food Tour', category: 'Food & Dining', estimatedCost: 10, durationHours: 2 }
      ]
    },
    {
      _id: 'city_kochi_22',
      ...
      region: 'Asia',
      costIndex: '$',
      averageDailyBudget: 44,
      popularityScore: 90,
      matchPercent: 90,
      imageUrl: 'https://images.unsplash.com/photo-1602216056096-3b40cc0c9944?auto=format&fit=crop&w=1200&q=80',
      description: "Kerala's cosmopolitan harbour city blends Portuguese, Dutch, and British colonial heritage with serene backwater houseboat journeys, Kathakali dance, and spice-laden seafood cuisine.",
      climate: 'Tropical Monsoon (Best: Oct - Feb)',
      currency: 'INR',
      highlights: ['Chinese Fishing Nets', 'Alleppey Backwaters', 'Fort Kochi', 'Kathakali Show'],
      topActivities: [
        { id: 'act_koc1', title: 'Alleppey Houseboat Overnight Backwaters Cruise', category: 'Sightseeing', estimatedCost: 55, durationHours: 18 },
        { id: 'act_koc2', title: 'Fort Kochi Chinese Fishing Nets Sunrise Walk', category: 'Culture', estimatedCost: 5, durationHours: 2 },
        { id: 'act_koc3', title: 'Kathakali Classical Dance Performance', category: 'Culture', estimatedCost: 12, durationHours: 2 },
        { id: 'act_koc4', title: 'Spice Market & Kerala Seafood Cooking Class', category: 'Food & Dining', estimatedCost: 28, durationHours: 3 }
      ]
    },
    {
      _id: 'city_rishikesh_23',
      name: 'Rishikesh',
      country: 'India',
      region: 'Asia',
      costIndex: '$',
      ...
      popularityScore: 88,
      matchPercent: 86,
      imageUrl: 'https://images.unsplash.com/photo-1591018049-e2c2f7ff5124?auto=format&fit=crop&w=1200&q=80',
      description: 'The Yoga Capital of the World — a spiritual Himalayan gateway on the sacred Ganges offering white-water rafting, cliff jumping, ashram stays, and iconic suspension bridges.',
      climate: 'Subtropical Highland (Best: Feb - Jun, Sep - Nov)',
      currency: 'INR',
      highlights: ['Laxman Jhula', 'Ganga Aarti at Triveni Ghat', 'White Water Rafting', 'Beatles Ashram'],
      topActivities: [
        { id: 'act_rsh1', title: 'Ganges White-Water Rafting & Cliff Jump', category: 'Adventure', estimatedCost: 22, durationHours: 3 },
        { id: 'act_rsh2', title: 'Sunrise Yoga & Meditation at Riverside Ashram', category: 'Culture', estimatedCost: 8, durationHours: 2 },
        { id: 'act_rsh3', title: 'Beatles Ashram Jungle Walk & Photography', category: 'Sightseeing', estimatedCost: 5, durationHours: 2 },
        { id: 'act_rsh4', title: 'Triveni Ghat Ganga Aarti & Holy Dip', category: 'Culture', estimatedCost: 0, durationHours: 1.5 }
      ]
    },
    {
      _id: 'city_amritsar_24',
      name: 'Amritsar',
      country: 'India',
      region: 'Asia',
      costIndex: '$',
      ...
      popularityScore: 89,
      matchPercent: 88,
      imageUrl: 'https://images.unsplash.com/photo-1609766856923-7b8b74a5c74d?auto=format&fit=crop&w=1200&q=80',
      description: "Home to the transcendent Golden Temple - Sikhism's holiest shrine - and the sobering Jallianwala Bagh memorial, plus the world's most theatrical border-closing ceremony at Wagah.",
      climate: 'Semi-arid (Best: Oct - Mar)',
      currency: 'INR',
      highlights: ['Golden Temple', 'Wagah Border', 'Jallianwala Bagh', 'Durgiana Temple'],
      topActivities: [
        { id: 'act_amt1', title: 'Golden Temple Amrit Vela (4am) Sunrise Visit', category: 'Culture', estimatedCost: 0, durationHours: 3 },
        { id: 'act_amt2', title: 'Wagah Border Beating Retreat Ceremony', category: 'Culture', estimatedCost: 5, durationHours: 3 },
        { id: 'act_amt3', title: 'Langar Community Kitchen Volunteering', category: 'Culture', estimatedCost: 0, durationHours: 2 },
        { id: 'act_amt4', title: 'Amritsari Kulcha & Lassi Street Food Walk', category: 'Food & Dining', estimatedCost: 8, durationHours: 2 }
       ]
    }
  ];
}
